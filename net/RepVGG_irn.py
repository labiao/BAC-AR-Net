...
class Net(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        # backbone
        self.repvgg = create_RepVGG_B1g2(deploy=False)

        if pretrained:
            checkpoint = torch.load(r'/mnt/sdb1/zhengdaoyuan/PycharmProjects/AMN/weights/RepVGG-B1g2-train.pth')
            if 'state_dict' in checkpoint:
                checkpoint = checkpoint['state_dict']
            ckpt = {k.replace('module.', ''): v for k, v in checkpoint.items()}  # strip the names
            self.repvgg.load_state_dict(ckpt)

        self.stage1 = self.repvgg.stage0
        self.stage2 = self.repvgg.stage1
        self.stage3 = self.repvgg.stage2
        self.stage4 = self.repvgg.stage3
        self.stage5 = self.repvgg.stage4
    ...
    def forward(self, x):
        ...
        # print(dp1.shape, dp2.shape, dp_up3.shape)
...
class AffinityDisplacementLoss(Net):
    ...
    def forward(self, *inputs):
        ...
        return pos_aff_loss, neg_aff_loss, dp_fg_loss, dp_bg_loss, edge_out
